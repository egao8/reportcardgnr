var dynamoStories = [
    ...
    "Awesome job this session {name}! You made so many new friends this session and were kind to everyone! I saw so much improvement on {compliment} this session. For the next session keep working on your {improvement}. I know you can do it, you just need to get a bit more comfortable trying new skills. Keep up the great work.",
    ...
    "You did so great this session {name}! You had a great coach-able attitude all session! I saw great improvement on your {compliment} as you picked it up super fast. Next session keep practicing your {improvement}! Great work {name}!",
];
